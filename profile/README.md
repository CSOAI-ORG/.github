...
_derived 2026-09-05T14:35:11Z by [`scripts/github/org-readme.py`](https://github.com/CSOAI-ORG/councilof-ai/blob/master/scripts/github/org-readme.py) — every number on this page is read live from the URLs in that script; if this page and the API disagree, the API is right._
...
| Third-party Hub cells | **753** cells: MEASURED 753 · UNMEASURED 0 · complete read: True | [`/api/hub-cards`](https://councilof.ai/api/hub-cards) |
...
Three different card numbers appear above on purpose and are never reconciled here: the **signed-card chain** (335), the **public-root leaf count** (167) and the **Hub cells** (753) are three populations with three source URLs. Quote each with its URL.
...
<sub>CS<strong>O</strong>AI · CSOAI Ltd · UK Companies House 16939677 · 3rd Floor 86-90 Paul Street, London EC2A 4NE · nicholas@csoai.org · [councilof.ai](https://councilof.ai) · derived 2026-09-05T14:35:11Z</sub>
