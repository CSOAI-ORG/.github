...
**Truth rail:** [`/api/gspc`](https://councilof.ai/api/gspc) — quote `totals.public_count` (do not freeze 13/14)  
...
| **API agent** | `/api/gspc` | 200 | public_count + schema | **PASS** (quote living GET) |
